...
export const Signup = () => {
  ...
  return (
    <AuthLayout title="Create your account" subtitle="Start building your personal content vault today">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-2 border rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors ${user.email ? "border-red-500" : "border-gray-300"
                }`}
              required
            />
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-10 py-2 border rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors ${user.password ? "border-red-500" : "border-gray-300"}`}
              required
            />
            <button
              type="button"
